...
const SD1_ALL = [...SD1_SCENARIOS, ...SD1_SCENARIOS_B];
const SD2_ALL = [...SD2_SCENARIOS, ...SD2_SCENARIOS_B];
const SOC1_ALL = [...SOC1_SCENARIOS, ...SOC1_SCENARIOS_B];
const SOC2_ALL = [...SOC2_SCENARIOS, ...SOC2_SCENARIOS_B];
const CIRT_ALL = [...CIRT_SCENARIOS, ...CIRT_SCENARIOS_B];
